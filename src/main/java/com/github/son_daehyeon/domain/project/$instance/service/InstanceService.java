package com.github.son_daehyeon.domain.project.$instance.service;
...
import com.github.son_daehyeon.domain.project.$instance.exception.CannotShrinkDiskException;
...
import com.github.son_daehyeon.domain.project.$instance.repository.VmidRepository;
...
public class InstanceService {
    ...
    private Vmid nextVmid() {
        ...
        Vmid vmid = vmidRepository.findAll().getLast();
